...
for ((i=0;i<5;i+=1))
do
    python3 main.py  --domain point --difficulty maze_easy --alg p-oac --n_estimators 10 --delta 0.95 --max_path_length 300   --num_layers 2 --layer_size 32 --batch_size 64 --no_gpu  --num_eval_steps_per_epoch 3000 --num_expl_steps_per_train_loop 3000 --replay_buffer_size 2e6 --r_max -1 --r_min -1.1 --share_layers  --counts --epochs 2000 --clip_state --max_state 25 --terminal --no_train_bias --suffix no_bias_/ &
done

for ((i=0;i<5;i+=1))
do
    python3 main.py  --domain point --difficulty maze_easy --alg oac --beta_UB=4.66 --delta=50 --max_path_length 300    --num_layers 2 --layer_size 32 --batch_size 64 --no_gpu --num_eval_steps_per_epoch 3000 --num_expl_steps_per_train_loop 3000 --replay_buffer_size 2e6  --epochs 2000 --clip_state --max_state 25 --terminal --suffix large_buffer/ &
done
for ((i=0;i<5;i+=1))
do
    python3 main.py  --domain point --difficulty maze_easy --alg sac --max_path_length 300    --num_layers 2 --layer_size 32 --batch_size 64 --no_gpu  --num_eval_steps_per_epoch 3000 --num_expl_steps_per_train_loop 3000 --replay_buffer_size 2e6  --epochs 2000 --clip_state --max_state 25 --terminal --suffix large_buffer/ &
done
for ((i=0;i<5;i+=1))
do
